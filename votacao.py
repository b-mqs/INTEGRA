...
#Cria a conexão com o banco e as tabelas
...
#Encrypta a senha para o registro e login
...
#Insere o usuário registrado na tabela
        try:
            cursor.execute("""
...
#Cria as Variáveis das opções de voto
votos_Candidato1 = 0
votos_Candidato2 = 0
votos_Candidato3 = 0
votos_CandidatoA = 0
...
def votar(usuario_cpf):
    ...
    while True:
        ...
        if grupo == '3':
            ...
            input("Pressione Enter para continuar...")
#Divide os grupos  de professores e funcionários
def realizar_voto_grupo(grupo, usuario_cpf):
    ...
    if grupo == '1':
        ...
        try:
            ...
            input("Pressione Enter para continuar...")
            return
#Checa a tabela e busca o cpf para verificar o voto no grupo
